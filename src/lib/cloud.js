...
export const TENANT_ID = "c3485a3b-b394-47ee-a4c1-e2d1dd98bdfb";            // <— Directory (tenant) ID (GUID)
export const CLIENT_ID = "48bd814b-47b9-4310-8c9d-af61d450cedc";      // <— Application (client) ID (GUID)

          ...
          <div className="bg-white rounded-2xl shadow p-4 w-full max-w-3xl" onClick={e=>e.stopPropagation()}>
            ...
            <div className="mt-4 border rounded-xl p-3">
              ...
              <div className="flex gap-2 mb-2">
                <select className="border rounded px-2 py-1" onChange={e=>{ addSupplierToProject(e.target.value); e.target.value=""; }}>
                  ...
                  {draft.supplierIds.map(id=>{
                    ...
                    return (
                      <li key={id} className="flex items-center justify-between gap-2">
                        ...
                        <button className="text-xs px-2 py-1 rounded bg-rose-500 text-white" onClick={()=>removeSupplierFromProject(id)} type="button">Ta bort</button>
                      </li>
                    );
                  })}
                </ul>
